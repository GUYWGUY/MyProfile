    ...
    <div className={`max-w-5xl mx-auto px-4 py-8 transition-colors duration-1000 ${stressFactor > 80 ? 'bg-red-950/20' : ''}`}>
      ...
      <header className="bg-white p-8 rounded-2xl shadow-sm border-t-4 border-ariel-turquoise mb-8 border border-slate-100 relative">
        <div className="flex flex-col md:flex-row justify-between items-start gap-6">
          <div className="flex-grow">
            <h1 className="text-3xl font-black text-ariel-blue mb-2">רווחת נהגי תחבורה ציבורית (2025)</h1>
      ...
      <div className="grid lg:grid-cols-3 gap-8 mb-12">
        ...
        <div className="lg:col-span-1 bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex flex-col gap-8">
          ...
          <div className={`mt-auto p-5 rounded-2xl border transition-colors duration-500 ${stressFactor > 45 ? 'bg-orange-50 border-orange-200' : 'bg-ariel-turquoise border-ariel-turquoise'}`}>
          ...
          <div className="flex justify-between items-center mb-8 relative z-10">
             ...
             <div className="flex gap-6">
                <div className="text-right">
                  ...
                  <div className={`text-2xl font-mono font-bold transition-colors ${currentHR > 120 ? 'text-red-500' : 'text-ariel-turquoise'}`}>
