      ...
      <header className="bg-white p-8 rounded-2xl shadow-sm border-t-4 border-ariel-turquoise mb-8 border border-slate-100 relative">
        <div className="flex flex-col md:flex-row justify-between items-start gap-6">
          <div className="flex-grow">
            <h1 className="text-3xl font-black text-ariel-blue mb-2">תכנון מסלולי פינוי תיירים (2021)</h1>
      ...
      <div className="bg-ariel-blue text-white rounded-2xl shadow-2xl p-6 mb-12 border border-gray-800">
        <div className="flex flex-col md:flex-row justify-between items-center mb-6">
          <h3 className="text-xl font-bold flex items-center gap-2">
            <i className="fas fa-map-marked-alt text-ariel-turquoise"></i> סימולטור פינוי חכם
          </h3>
          <div className="flex gap-4 mt-4 md:mt-0 bg-white/10 p-2 rounded-lg items-center">
            <button 
        ...
        <div className="flex flex-col items-center">
          <div className="w-full max-w-md flex justify-between text-xs font-mono text-ariel-turquoise mb-1 px-1">
              ...
              return (
                <div 
                  ...
                  className={`aspect-square relative rounded-sm transition-colors duration-200 cursor-pointer flex items-center justify-center
                    ...
                    ${cellType === 'safe' ? 'bg-ariel-turquoise shadow-[0_0_15px_rgba(0,150,57,0.4)]' : ''}
                ...
                >
                  ...
                  {agent && (
                    <div className={`w-[80%] h-[80%] rounded-full absolute z-10 transition-all duration-300 shadow-md
                      ${agent.isSmart ? 'bg-ariel-turquoise border-2 border-white' : (isAlarmActive ? 'bg-red-500 animate-pulse' : 'bg-blue-500')}
                    `} />
                  )}
                </div>
              );
          ...
          <div className="mt-6 flex gap-6 text-[10px] font-mono uppercase tracking-wider text-slate-400">
            ...
            <div className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-ariel-turquoise border border-white"></div> מונחה (חכם)</div>
          </div>
          
          <div className="mt-4 font-mono text-white text-sm bg-white/10 px-6 py-2 rounded-full border border-white/20">
            מפונים: <span className="text-ariel-turquoise font-bold text-lg">{escapedCount}</span> / {AGENT_COUNT}
          </div>
        </div>
      </div>
