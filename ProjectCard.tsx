    ...
    >
      <div className="h-48 bg-slate-800 relative overflow-hidden shrink-0">
        <img 
          ...
          onError={(e) => {
            (e.target as HTMLImageElement).src = `https://ui-avatars.com/api/?name=${encodeURIComponent(paper.title)}&background=1e293b&color=fff&size=512`;
          }}
        />
      ...
      <div className="p-6 flex flex-col flex-grow text-right" dir="rtl">
        ...
        <button className="text-ariel-green font-bold text-sm flex items-center gap-1 hover:gap-2 transition-all mt-4 self-start">
